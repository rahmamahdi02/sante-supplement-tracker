      ...
      <Navbar data-testid="navbar" bg="" variant="dark" sticky="top">
        <Container>
          ...
          <Navbar.Collapse className="justify-content-end">
            ...
            <Navbar.Text>
              {!isAuthenticated ? (<button className=" ui blue basic button" onClick={() => loginWithRedirect()}>Sign Up</button> ) : (<button className="ui grey basic button" onClick={() => logout({ logoutParams: { returnTo: window.location.origin } })}>
              Profile
              </button>)}
